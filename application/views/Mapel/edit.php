            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" style="margin: 2em;">
                ...
                <div class="form-group" style="margin-top: 3em;">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="kode" readonly value="<?=$mapel['kode_mapel'];?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label" style="font-weight: bold;">Nama Mata Pelajaran</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="nama" value="<?=$mapel['nama_mapel'];?>">
                  </div>
                </div>
                <div class="form-group">
