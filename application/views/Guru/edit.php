        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right "></i> Edit Data Guru</h4>
              <form class="form-horizontal style-form" method="post" style="margin: 2em;">
                ...
                <div class="form-group" style="margin-top: 3em;">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="nip" value="<?=$guru['nip']?>" readonly>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label" style="font-weight: bold;">Nama Guru</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="nama" value="<?=$guru['nama_guru']?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="radio">
                      <label>
                        <input type="radio" name="jenisKelamin" id="laki" value="L" <?php if($guru['jk_guru']=='L') { echo 'checked';}?>>
                        Laki-laki
                        </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="jenisKelamin" id="perempuan" value="P" <?php if($guru['jk_guru']=='P') { echo 'checked';}?>>
                        Perempuan
                        </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <textarea class="form-control " name="alamat"><?=$guru['alamat_guru']?></textarea>
                  </div>
                </div>
                <!-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <select name="mapel">
                      ...
                      <option value="<?=$mpl['kode_mapel']?>" <?php if($guru['kode_mapel'] == $mpl['kode_mapel']) : echo 'selected'; endif; ?>><?= $mpl['nama_mapel'];?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                </div>
